...
export function Skills() {
  return (
    <section id="skills" className="w-full py-24 bg-background/50 border-t border-border/40">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {skillCategories.map((category) => {
            ...
            return (
              <Card key={category.id} className="border-border/50 bg-card/30 transition-colors hover:border-primary/40 hover:bg-card/50">
